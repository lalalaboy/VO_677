...
int optimize_depth_gpu(
	...
	cudaEventElapsedTime(&local_timing.cache_upload_ms, event_start, event_stop);
	cudaEventRecord(event_start, 0);
	...
	if (!update_rigidness_only) {
		...
		cudaEventRecord(event_stop, 0);
		cudaEventSynchronize(event_stop);
		cudaEventElapsedTime(&local_timing.fb_smooth_ms, event_start, event_stop);
		cudaEventRecord(event_start, 0);
		...
		cudaEventRecord(event_stop, 0);
		cudaEventSynchronize(event_stop);
		cudaEventElapsedTime(&local_timing.init_cost_ms, event_start, event_stop);
		cudaEventRecord(event_start, 0);
		...
		cudaEventRecord(event_stop, 0);
		cudaEventSynchronize(event_stop);
		cudaEventElapsedTime(&local_timing.rand_prop_ms, event_start, event_stop);
		cudaEventRecord(event_start, 0);
		...
		cudaEventRecord(event_stop, 0);
		cudaEventSynchronize(event_stop);
		cudaEventElapsedTime(&local_timing.global_prop_ms, event_start, event_stop);
		cudaEventRecord(event_start, 0);
		...
		cudaEventRecord(event_stop, 0);
		cudaEventSynchronize(event_stop);
		cudaEventElapsedTime(&local_timing.local_prop_ms, event_start, event_stop);
		cudaEventRecord(event_start, 0);
	}
	else {
		cudaEventRecord(event_stop, 0);
	...
	cudaEventRecord(event_stop, 0);
	cudaEventSynchronize(event_stop);
	cudaEventElapsedTime(&local_timing.update_rigidness_ms, event_start, event_stop);
	cudaEventRecord(event_start, 0);
	...
	cudaEventRecord(event_stop, 0);
	cudaEventSynchronize(event_stop);
	cudaEventElapsedTime(&local_timing.copy_back_ms, event_start, event_stop);
